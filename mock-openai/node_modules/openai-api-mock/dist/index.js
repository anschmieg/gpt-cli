...
function createDefaultResponse(created) {
  return {
    ...
    created,
    id: `chatcmpl-${f.string.alphanumeric(30)}`,
    model: `gpt-3.5-mock`,
...
function createToolCallObject(requestBody) {
  return {
    id: `call-${f.string.alphanumeric(30)}`,
    type: "function",
    function: {
...
function getImageResponce(requestBody) {
  const n2 = requestBody.n || 1;
  const data = [];
  for (let i2 = 0; i2 < n2; i2++) {
    data.push({
      revised_prompt: f.lorem.words(5),
